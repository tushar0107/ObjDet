...
def main():
    ...
    layout = [[sg.Text('Object Detection', size=(40, 1), justification='center', font='Helvetica 20')],
    ...
    window = sg.Window('Object Detection',layout, location=(900, 400),finalize=True)
